...
## Performance Considerations<a name="w3ab1c58b9b8"></a>

Amazon Kinesis shard throughput is directly proportional to the instance size of nodes in Amazon EMR clusters and record size in the stream\. We recommend that you use m3\.xlarge or larger instances on master and core nodes\.

## Schedule Amazon Kinesis Analysis with Amazon EMR<a name="w3ab1c58b9c10"></a>

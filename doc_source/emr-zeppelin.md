...
For the version of components installed with Zeppelin in this release, see [Release 6\.1\.0 Component Versions](emr-release-6x.md#emr-610-release)\.
...
For the version of components installed with Zeppelin in this release, see [Release 5\.31\.0 Component Versions](emr-release-5x.md#emr-5310-release)\.

...
For the version of components installed with TensorFlow in this release, see [Release 6\.5\.0 Component Versions](emr-650-release.md)\.


**TensorFlow version information for emr\-6\.5\.0**  

| Amazon EMR Release Label | TensorFlow Version | Components Installed With TensorFlow | 
| --- | --- | --- | 
| emr\-6\.5\.0 | TensorFlow 2\.4\.1 | emrfs, emr\-goodies, hadoop\-client, hadoop\-hdfs\-datanode, hadoop\-hdfs\-library, hadoop\-hdfs\-namenode, hadoop\-httpfs\-server, hadoop\-kms\-server, hadoop\-yarn\-nodemanager, hadoop\-yarn\-resourcemanager, hadoop\-yarn\-timeline\-server, tensorflow | 
...
For the version of components installed with TensorFlow in this release, see [Release 5\.34\.0 Component Versions](emr-5340-release.md)\.


**TensorFlow version information for emr\-5\.34\.0**  

| Amazon EMR Release Label | TensorFlow Version | Components Installed With TensorFlow | 
| --- | --- | --- | 
| emr\-5\.34\.0 | TensorFlow 2\.4\.1 | emrfs, emr\-goodies, hadoop\-client, hadoop\-hdfs\-datanode, hadoop\-hdfs\-library, hadoop\-hdfs\-namenode, hadoop\-httpfs\-server, hadoop\-kms\-server, hadoop\-yarn\-nodemanager, hadoop\-yarn\-resourcemanager, hadoop\-yarn\-timeline\-server, tensorflow | 

## TensorFlow builds by Amazon EC2 instance type<a name="w173aac59c17"></a>
...
## Security<a name="w173aac59c19"></a>

...
```
aws emr create-cluster --use-default-roles --release-label emr-5.18.0 --instance-type m4.large --instance-count 2 --applications Name=Hive --configurations https://s3.amazonaws.com/mybucket/myfolder/myConfig.json
```

If you configuration is in your local directory, you can use the following:

```
aws emr create-cluster --use-default-roles --release-label emr-5.18.0 --applications Name=Hive \

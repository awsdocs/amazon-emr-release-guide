...
## Supplying a Configuration in the Console<a name="w3aac14c26"></a>
...
## Supplying a Configuration Using the CLI<a name="w3aac14c28"></a>
...
```
aws emr create-cluster --use-default-roles --release-label emr-5.17.0 --instance-type m4.large --instance-count 2 --applications Name=Hive --configurations https://s3.amazonaws.com/mybucket/myfolder/myConfig.json
```

If you configuration is in your local directory, you can use the following:

```
aws emr create-cluster --use-default-roles --release-label emr-5.17.0 --applications Name=Hive \
--instance-type m4.large --instance-count 3 --configurations file://./configurations.json
```

## Supplying a Configuration Using the Java SDK<a name="w3aac14c30"></a>
...
## Service ports<a name="w3aac14c34"></a>
...
## Application users<a name="w3aac14c36"></a>

...
## Supplying a Configuration in the Console<a name="w3ab1c14c24"></a>
...
## Supplying a Configuration Using the CLI<a name="w3ab1c14c26"></a>
...
```
aws emr create-cluster --use-default-roles --release-label emr-5.14.0 --applications Name=Hive \
--instance-type m4.large --instance-count 3 --configurations file://./configurations.json
```

## Supplying a Configuration Using the Java SDK<a name="w3ab1c14c28"></a>
...
## Service ports<a name="w3ab1c14c32"></a>
...
## Application users<a name="w3ab1c14c34"></a>

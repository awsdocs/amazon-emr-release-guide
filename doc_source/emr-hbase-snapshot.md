...
## Create a snapshot using a table<a name="w40aac26c31b4"></a>
...
## Delete a snapshot<a name="w40aac26c31b6"></a>
...
## View snapshot info<a name="w40aac26c31b8"></a>

```
hbase snapshot info -snapshot snapshotName
```

## Export a snapshot to Amazon S3<a name="w40aac26c31c10"></a>
...
## Import snapshot from Amazon S3<a name="w40aac26c31c12"></a>
...
## Restore a table from snapshots within the HBase shell<a name="w40aac26c31c14"></a>

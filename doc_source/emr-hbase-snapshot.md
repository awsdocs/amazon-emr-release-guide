...
## Create a snapshot using a table<a name="w162aac25c39b4"></a>
...
## Delete a snapshot<a name="w162aac25c39b6"></a>
...
## View snapshot info<a name="w162aac25c39b8"></a>

```
hbase snapshot info -snapshot snapshotName
```

## Export a snapshot to Amazon S3<a name="w162aac25c39c10"></a>
...
## Import snapshot from Amazon S3<a name="w162aac25c39c12"></a>
...
## Restore a table from snapshots within the HBase shell<a name="w162aac25c39c14"></a>

...
+ *emr\-release\-label* is the release label for the Amazon EMR cluster that will run your code\. Release labels are in the form `emr-x.x.x. For example, emr-5.18.0.` 
...
<project>
	...
	<repositories>
		...
		<repository>
			...
			<url>https://s3.us-west-1.amazonaws.com/emr.artifacts.us-west-1/emr-5.18.0/repo/maven/</url>
		</repository>
		...
	</repositories>
	...

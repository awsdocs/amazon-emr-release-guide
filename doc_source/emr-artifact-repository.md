...
+ *emr\-release\-label* is the release label for the Amazon EMR cluster that will run your code\. Release labels are in the form `emr-x.x.x`, such as, `emr-5.31.0`\. An EMR release series may include multiple releases\. For example, if you're using EMR release version 5\.24\.1, use the first EMR release label within the 5\.24 series, `emr-5.24.0`, in the artifact repository URL: 

# Apache MXNet<a name="emr-mxnet"></a>
...
For the version of components installed with MXNet in this release, see [Release 6\.4\.0 Component Versions](emr-640-release.md)\.


**MXNet version information for emr\-6\.4\.0**  

| Amazon EMR Release Label | MXNet Version | Components Installed With MXNet | 
| --- | --- | --- | 
| emr\-6\.4\.0 | MXNet 1\.8\.0 | emrfs, emr\-goodies, hadoop\-client, hadoop\-hdfs\-datanode, hadoop\-hdfs\-library, hadoop\-hdfs\-namenode, hadoop\-httpfs\-server, hadoop\-kms\-server, hadoop\-yarn\-nodemanager, hadoop\-yarn\-resourcemanager, hadoop\-yarn\-timeline\-server, mxnet, opencv | 
...
For the version of components installed with MXNet in this release, see [Release 5\.33\.0 Component Versions](emr-5330-release.md)\.

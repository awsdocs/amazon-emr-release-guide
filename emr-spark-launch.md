...
1.  For **Software Configuration**, choose **Amazon Release Version *emr\-5\.23\.0*** or later\.
...
+ Create the cluster with the following command:
  ...
  ```
  aws emr create-cluster --name "Spark cluster" --release-label emr-5.23.0 --applications Name=Spark \
